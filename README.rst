...
In order to install Pyaedt-qt-ui library, make sure you
...
.. code:: bash
    ...
    python -m pip install ansys-aedt-qt-ui-library

For developers
^^^^^^^^^^^^^^

Installing Pyaedt-qt-ui library in developer mode allows
...
1. Start by cloning this repository:
    ...
    .. code:: bash
        ...
        git clone https://github.com/pyansys/pyaedt-qt-ui
...
4. Install the project in editable mode:
    ...
    .. code:: bash
        ...
        python -m pip install --editable ansys-aedt-qt-ui-library
